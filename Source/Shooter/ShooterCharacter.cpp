...
void AShooterCharacter::InitializeInterpLocations()
{
	...
	FInterpLocation InterpLoc6{ InterpComp7, 0 };
	InterpLocations.Add(InterpLoc7);
}
...
void AShooterCharacter::FiveKeyPressed()
{
	if (EquippedWeapon->GetSlotIndex() == 6) return;
	ExchangeInventoryItems(EquippedWeapon->GetSlotIndex(), 6);
}
